...
const CategoryGalleryItem: React.FC<CategoryGalleryItemProps> = ({ categoryName, imageUrl, categoryUrl }) => {
    return (
        <div className="mb-2 relative gallery-item">
            <Image className="object-cover image-gallery" src={imageUrl} alt="Category Image" width={400} height={200} />
            <p className="text-gallery text-center">
                {categoryName}
            </p>
            <div className="absolute top-0 bottom-0 left-0 right-0 opacity-0 gallery-overlay hover:opacity-75 bg-gray-900 flex items-center justify-center">
