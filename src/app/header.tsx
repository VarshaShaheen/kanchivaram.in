                ...
                <div>
                    ...
                    >
                        <ul className="h-auto items-center justify-center md:flex ">
                            <li className=" text-sm px-4 text-center md:border-b-0 hover:bg-green-700 border-green-700 hover:text-green-700 hover:bg-transparent ">
                                <Link href="/about" onClick={() => setNavbar(!navbar)}>
                                    ABOUT
                                </Link>
                            </li>
                            <li className=" text-sm px-4 text-center  md:border-b-0 hover:bg-green-700 border-green-700 md:hover:text-green-700 md:hover:bg-transparent">
